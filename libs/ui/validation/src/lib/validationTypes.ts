...
export const NAME_BASE = function () {
  const minCount = 0;
...
export const LABEL_NAME_BASE = function () {
  const maxCount = 63;
  const maxCountError = `There is a ${maxCount} character limit`;
...
export const LONG_NAME_BASE = function () {
  const minCount = 0;
  const minCountError = `There is a minimal ${minCount} character limit`;
  const maxCount = 255;
  const maxCountError = `There is a ${maxCount} character limit`;
...
export const DESCRIPTION_BASE = function () {
  const minCount = 0;
  const minCountError = `There is a minimal ${minCount} character limit`;
  const maxCount = 2048;
  const maxCountError = `There is a ${maxCount} character limit`;
...
export const EMAIL_BASE = function () {
  const requiredError = REQUIRED_ERROR;
...
export const INTEGER_BASE = function () {
  const requiredError = REQUIRED_ERROR;
...
export const LATITUDE_BASE = function () {
  const requiredError = REQUIRED_ERROR;
...
export const LONGITUDE_BASE = function () {
  const requiredError = REQUIRED_ERROR;
...
export const UUID_BASE = function () {
  const requiredError = REQUIRED_ERROR;
...
export const URL_BASE = function () {
  const requiredError = REQUIRED_ERROR;
  const spacesError = SPACES_ERROR;
