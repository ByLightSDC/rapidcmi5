...
import { computeCourseFromJsonFs, createCourseInFs, createLesson, getCourseDataInFs, slugifyPath } from '../session/useCourseOperationsUtils';
...
async function setupTestContext(): Promise<TestContext> {
  ...
  const gitOperator = new GitOperations(instance);
  await gitOperator.initGitRepo(r, 'main');
 ...
 */
async function createAndVerifyLesson(
  ctx: TestContext,
  coursePath: string,
  courseData: any,
  lessonName: string,
