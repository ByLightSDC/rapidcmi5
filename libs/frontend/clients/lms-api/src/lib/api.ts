...
export const Cmi5ManagementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        cmi5Build: async (file: File, createAuMappings: boolean, duration?: number, selfEnrollable?: boolean, seats?: number, workRoles?: Array<string>, topicTags?: Array<string>, platforms?: Array<string>, requirements?: Array<string>, courseLevel?: Cmi5BuildCourseLevelEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const Cmi5ManagementApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async cmi5Build(file: File, createAuMappings: boolean, duration?: number, selfEnrollable?: boolean, seats?: number, workRoles?: Array<string>, topicTags?: Array<string>, platforms?: Array<string>, requirements?: Array<string>, courseLevel?: Cmi5BuildCourseLevelEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.cmi5Build(file, createAuMappings, duration, selfEnrollable, seats, workRoles, topicTags, platforms, requirements, courseLevel, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const Cmi5ManagementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        cmi5Build(file: File, createAuMappings: boolean, duration?: number, selfEnrollable?: boolean, seats?: number, workRoles?: Array<string>, topicTags?: Array<string>, platforms?: Array<string>, requirements?: Array<string>, courseLevel?: Cmi5BuildCourseLevelEnum, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.cmi5Build(file, createAuMappings, duration, selfEnrollable, seats, workRoles, topicTags, platforms, requirements, courseLevel, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get the launch url for a specific au in a cmi5 course
...
export class Cmi5ManagementApi extends BaseAPI {
     ...
     */
    public cmi5Build(file: File, createAuMappings: boolean, duration?: number, selfEnrollable?: boolean, seats?: number, workRoles?: Array<string>, topicTags?: Array<string>, platforms?: Array<string>, requirements?: Array<string>, courseLevel?: Cmi5BuildCourseLevelEnum, options?: RawAxiosRequestConfig) {
        return Cmi5ManagementApiFp(this.configuration).cmi5Build(file, createAuMappings, duration, selfEnrollable, seats, workRoles, topicTags, platforms, requirements, courseLevel, options).then((request) => request(this.axios, this.basePath));
    }
...
export const CourseInstructorApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        courseList1: async (author?: string, dateCreated?: string, dateEdited?: string, courseType?: CourseList1CourseTypeEnum, offset?: number, limit?: number, search?: string, sortBy?: CourseList1SortByEnum, sort?: CourseList1SortEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const CourseInstructorApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async courseList1(author?: string, dateCreated?: string, dateEdited?: string, courseType?: CourseList1CourseTypeEnum, offset?: number, limit?: number, search?: string, sortBy?: CourseList1SortByEnum, sort?: CourseList1SortEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CourseList200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.courseList1(author, dateCreated, dateEdited, courseType, offset, limit, search, sortBy, sort, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CourseInstructorApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        courseList1(author?: string, dateCreated?: string, dateEdited?: string, courseType?: CourseList1CourseTypeEnum, offset?: number, limit?: number, search?: string, sortBy?: CourseList1SortByEnum, sort?: CourseList1SortEnum, options?: RawAxiosRequestConfig): AxiosPromise<CourseList200Response> {
            return localVarFp.courseList1(author, dateCreated, dateEdited, courseType, offset, limit, search, sortBy, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Unassign the instructor from managing a course
...
export class CourseInstructorApi extends BaseAPI {
     ...
     * @memberof CourseInstructorApi
     */
    public courseList1(author?: string, dateCreated?: string, dateEdited?: string, courseType?: CourseList1CourseTypeEnum, offset?: number, limit?: number, search?: string, sortBy?: CourseList1SortByEnum, sort?: CourseList1SortEnum, options?: RawAxiosRequestConfig) {
        return CourseInstructorApiFp(this.configuration).courseList1(author, dateCreated, dateEdited, courseType, offset, limit, search, sortBy, sort, options).then((request) => request(this.axios, this.basePath));
    }
