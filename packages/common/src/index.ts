...
export * from './lib/types/activities/activity';
export * from './lib/types/ui/admonition';
export * from './lib/types/courseStructure/course';
...
export * from './lib/types/courseStructure/slide';
