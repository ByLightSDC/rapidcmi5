...
const mockTopic = 'cluster-range-networks';
...
const listNetworks = [
  {
    ...
    labels: { 'bylight.com': 'work', 'bylight.com/private': 'home' },
    name: 'Mock Cluster Network',
