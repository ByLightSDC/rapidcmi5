...
export const rangeResourceAutoIP = [
  // GET list
  http.get(
  ...
  // GET specific
  http.get(
    `${config.DEVOPS_API_URL}/v1/manage/range/${mockRangeId}/scenarios/${mockScenarioId}/${apiTopic}/111`,
    ({ request, params, cookies }) => {
