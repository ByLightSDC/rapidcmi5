...
const apiTopic = 'range-dns-records';
const list = [
  {
    author: 'andrew.thigpen@bylight.com',
    dateCreated: '2022-10-27T16:17:31.000Z',
    dateEdited: '2022-10-27T16:17:31.175Z',
    name: 'Mock Dns Record',
    description: 'mock description \non multiple lines',
    uuid: '222',
    ready: true,
    status: 'reconcilesuccess',
    zone: '12345678-6fb7-4997-8f3c-70f0a335d5a3',
  },
  {
    author: 'andrew.thigpen@bylight.com',
    dateCreated: '2022-10-27T16:17:31.000Z',
    dateEdited: '2022-10-27T16:17:31.175Z',
    name: 'Mock Dns Record 2',
    uuid: '222',
    ready: true,
    status: 'reconcilesuccess',
    zone: '22345678-6fb7-4997-8f3c-70f0a335d5a3',
  },
  {
    author: 'andrew.thigpen@bylight.com',
    dateCreated: '2022-10-27T16:17:31.000Z',
    dateEdited: '2022-10-27T16:17:31.175Z',
    name: 'Mock Dns Deleted Record 3',
    uuid: '333',
    ready: true,
    status: 'deleting',
    zone: '22345678-6fb7-4997-8f3c-70f0a335d5a3',
...
export const rangeResourceDnsRecord = [
  // GET list
  http.get(
