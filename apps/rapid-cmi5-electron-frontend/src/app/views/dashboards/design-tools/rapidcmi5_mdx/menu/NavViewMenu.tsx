...
import { lightTheme } from 'apps/rapid-cmi5-electron-frontend/src/app/styles/muiTheme';
import { darkTheme } from 'apps/rapid-cmi5-electron-frontend/src/app/styles/muiThemeDark';
