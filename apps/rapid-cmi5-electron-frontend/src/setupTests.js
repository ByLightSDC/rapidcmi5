...
jest.mock('../../../libs/ui/api/hooks/src/lib/useCountryCodes', () => ({
  // the useGetCountryCodes hook "refornats" what comes from the BE for the UI to use
  useGetCountryCodes: () => ({
    status: 'success',
    isLoading: false,
    isSuccess: true,
...
jest.mock('../../../libs/ui/api/hooks/src/lib/useRangeDnsZones', () => ({
  useGetRangeDnsZones: () => ({
    status: 'success',
    isLoading: false,
    isSuccess: true,
...
jest.mock('../../../libs/ui/api/hooks/src/lib/useRangeDnsServerTags', () => ({
  useGetDnsServerTags: () => ({
    status: 'success',
    isLoading: false,
    isSuccess: true,
...
jest.mock('../../../libs/ui/api/hooks/src/lib/useRangeDnsZoneTags', () => ({
  useGetDnsZoneTags: () => ({
    status: 'success',
    isLoading: false,
    isSuccess: true,
