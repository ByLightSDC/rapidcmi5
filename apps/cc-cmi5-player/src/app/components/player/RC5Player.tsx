    ...
    const initialList = [
      ...
      directivesPlugin({
        directiveDescriptors: [
          ...
          withPlaybackDecoratorFix(GridContainerDirectiveDescriptor),
          withPlaybackDecoratorFix(GridCellDirectiveDescriptor),
          withPlaybackDecoratorFix(StepsDirectiveDescriptor),
          StepContentDirectiveDescriptor,
          withPlaybackDecoratorFix(TabsDirectiveDescriptor),
          TabContentDirectiveDescriptor,
          ImageLabelDirectiveDescriptor,
          ImageTextDirectiveDescriptor,
          withPlaybackDecoratorFix(QuotesContainerDirectiveDescriptor),
          withPlaybackDecoratorFix(QuotesContentDirectiveDescriptor),
