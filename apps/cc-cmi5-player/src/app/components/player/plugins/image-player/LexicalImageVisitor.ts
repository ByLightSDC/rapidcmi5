...
/**
 * Appends images as either inline or as an html <img />
 */
export const LexicalImageVisitor: LexicalExportVisitor<ImageNode, Mdast.Image> =
  {
    testLexicalNode: $isImageNode,
    visitLexicalNode({ mdastParent, lexicalNode, actions }) {
      // if the lexicalNode has height or width different from inherit, or if an
      // attribute like style is defined, append it as html
